...
class BallDontLieApiTest {
    ...
    @Test
    fun `getPlayers returns success`() = runTest {
        val json = """
            {
              "data": [
                {
    ...
    @Test
    fun `getPlayer parses single player wrapped in data envelope`() = runTest {
    ...
    @Test
    fun `getTeam parses single team wrapped in data envelope`() = runTest {
        val json = """
            {
              "data": {
                "id": 10,
    ...
    @Test
    fun `getTeams returns success`() = runTest {
        val json = """
            {
              "data": [
                {
