...
class PlayerDetailViewModelTest {
    ...
    @Test
    fun `LoadPlayer intent updates state with player on success`() = runTest {
    ...
    @Test
    fun `LoadPlayer intent updates state with error on failure`() = runTest {
        coEvery { getPlayerDetailUseCase(1) } throws Exception("Error")
    ...
    @Test
    fun `OnTeamClicked intent emits NavigateToTeamDetail effect`() = runTest {
